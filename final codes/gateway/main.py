    ...
    def post_data_to_publish():
        ...
        while True:
            ...
            for i in mq.topic:
                ...
                mq.data_publish({"dataPoint": now, "paramType": 'Sensor1', "paramValue": X, "deviceId": i})
                mq.data_publish({"dataPoint": now, "paramType": 'Sensor2', "paramValue": Y, "deviceId": i})
                mq.data_publish({"dataPoint": now, "paramType": 'Sensor3', "paramValue": Z, "deviceId": i})
